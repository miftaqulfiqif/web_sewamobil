        ...
        return $form
            ->schema([
                ...
                Forms\Components\DatePicker::make('tanggal_selesai')
                    ->required(),
                Forms\Components\TextInput::make('mobil_id')
                    ->required()
                    ->numeric(),
                Forms\Components\TextInput::make('data_user_id')
                    ->required()
                    ->numeric(),
            ]);
    }
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('tanggal_selesai')
                    ->date()
                    ->sortable(),
                Tables\Columns\TextColumn::make('mobil_id')
                    ->numeric()
                    ->sortable(),
                Tables\Columns\TextColumn::make('data_user_id')
                    ->numeric()
                    ->sortable(),
